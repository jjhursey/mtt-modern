#!/usr/bin/env python
"""Configure the environment for the MTT REST server.
...
tmpl_conf  = "bin/mtt_server_config.ini.tmpl"
final_conf = "bin/mtt_server_config.ini"
...
call([env_dir + '/bin/python', source_dir + '/mtt_install_stage_two.py'])
